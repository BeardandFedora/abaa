...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        htmlmin: {
            dist: {
                //                  Comment out htmlmin for projects that need
                //                  more work done after grunt build
                //                 options: {
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    cwd: '<%= config.app %>',
                    dest: '<%= config.dist %>',
                    src: ['*.{ico,png,txt}', 'images/{,*/}*.webp', '{,*/}*.html', 'styles/fonts/{,*/}*.*']
                }, {
        ...
        modernizr: {
            dist: {
                ...
                files: {
                    src: ['<%= config.dist %>/scripts/{,*/}*.js', '<%= config.dist %>/styles/{,*/}*.css', '!<%= config.dist %>/scripts/vendor/*']
                },
                uglify: true
            }
        },
    ...
    grunt.registerTask('build', ['clean:dist', 'wiredep', 'useminPrepare', 'concurrent:dist', 'autoprefixer', 'concat', 'cssmin', 'uglify', 'copy:dist', 'modernizr', 'rev', 'usemin', 'htmlmin']);
